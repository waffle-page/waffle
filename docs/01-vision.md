...
- Waffle Core does not depend on the Catalog. Catalog acquisition uses
  permitted metadata/APIs, feeds, licensed or compatible open datasets,
  standards, and partnerships; provider adapters collect evidence rather than
  define identity.
